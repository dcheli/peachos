...
// This is for our task linked list
...
// we want this to be static because we don't want people calling this function
...
void task_run_first_ever_task(){
    if(!current_task){
        panic("task_run_first_ever_task(): No curreht task exists!");
    }
